...
!(function(t) {
  function i() {
    (o = function(t) {
      ...
      t.each([o, a, r], function(t, i) {
        i.add = function(t) {
          t = t.split(" ");
          for (var e in t) i[t[e]] = i(t[e]);
        };
      }),
      o.add("touch desktop scale-1 scale-2 scale-3 wrapper opened opening fixed inline hover slider slide loading noanimation fastanimation"),
      a.add("slide anchor"),
      r.add(
        ...
        setViewportScale: function() {
          if (l.viewportScale) {
            ...
            "undefined" != typeof t &&
              ((t = 1 / t),
              l.$body
                .removeClass(o["scale-1"])
                .removeClass(o["scale-2"])
                .removeClass(o["scale-3"])
                .addClass(o["scale-" + Math.max(Math.min(Math.round(t), 3), 1)]));
          }
        }
      }),
      (l = { $wndw: t(window), $html: t("html"), $body: t("body"), scrollPosition: 0, viewportScale: null, viewportScaleInterval: null }),
      l.$body.addClass(t[e].support.touch ? o.touch : o.desktop),
      l.$wndw.on(r.scroll, function(t) {
      ...
      !l.viewportScale &&
        ...
        ((l.viewportScale = new FlameViewportScale()),
        d.setViewportScale(),
        l.$wndw.on(r.orientationchange + " " + r.resize, function(t) {
          l.viewportScaleInterval && (clearTimeout(l.viewportScaleInterval), (l.viewportScaleInterval = null)),
            (l.viewportScaleInterval = setTimeout(function() {
              d.setViewportScale();
            }, 500));
        })),
      (t[e]._c = o),
  ...
  if (!t[e]) {
    ...
    (t[e] = function(t, i, e) {
      ...
      (t[e].prototype = {
        _init: function() {
          ...
          this._complementOptions(),
            ...
            (this.nodes.$wrpr = t('<div class="' + o.wrapper + '" />')),
            (this.nodes.$sldr = t('<div class="' + o.slider + '" />').appendTo(this.nodes.$wrpr)),
            this.nodes.$wrpr
              .addClass(this.vars.fixed ? o.fixed : o.inline)
              .addClass(o("fx-" + this.opts.effect))
              .addClass(o(this.opts.slides.scale))
              .addClass(this.opts.wrapper.classes),
            this.nodes.$wrpr
              .on(r.open + " " + r.close + " " + r.prev + " " + r.next + " " + r.slideTo, function(t) {
            ...
            (this.slides.index = 0),
            (this.vars.opened = !0);
          for (var s = 0; s < t[e].addons.length; s++) t.isFunction(this["_addon_" + t[e].addons[s]]) && this["_addon_" + t[e].addons[s]]();
          for (var n = 0; n < t[e].ui.length; n++) this.nodes.$wrpr.find("." + o[t[e].ui[n]]).length && this.nodes.$wrpr.addClass(o("has-" + t[e].ui[n]));
          "close" == this.opts.wrapper.onClick &&
            ...
            this.vars.fixed
              ? (this.nodes.$wrpr.appendTo(l.$body), this.close(!0))
              : (this.nodes.$wrpr.appendTo(this.opts.wrapper.target), this.opts.show ? ((this.vars.opened = !1), this.open(0, !0)) : this.close(!0));
        },
        open: function(i, e) {
          var s = this;
          this.vars.opened ||
            (this.vars.fixed && ((l.scrollPosition = l.$wndw.scrollTop()), l.$body.addClass(o.opened), d.setViewportScale()),
            e
              ? this.nodes.$wrpr.addClass(o.opening).trigger(r.opening, [i, e])
              : setTimeout(function() {
                  s.nodes.$wrpr.addClass(o.opening).trigger(r.opening, [i, e]);
                }, 5),
            this.nodes.$wrpr.addClass(o.hover).addClass(o.opened)),
            (this.vars.opened = !0),
            this._loadContents(),
            t.isNumeric(i) && ((e = e || !this.vars.opened), this.slideTo(i, e));
        },
        close: function(i) {
          this.vars.opened &&
            (this.vars.fixed && l.$body.removeClass(o.opened),
            i
              ? this.nodes.$wrpr.removeClass(o.opened)
              : d.transitionend(
                  this.nodes.$wrpr,
                  function() {
            ...
            this.nodes.$wrpr
              .removeClass(o.hover)
              .removeClass(o.opening)
              .trigger(r.closing, [this.slides.index, i])),
            (this.vars.opened = !1);
        },
        prev: function(i, e) {
        ...
        slideTo: function(i, s) {
          ...
          if (((this.slides.index = i), this._loadContents(), n)) {
            ...
            this.slides.widthPercentage && (p += "%"),
              s &&
                (this.nodes.$sldr.addClass(o.noanimation),
                d.transitionend(
                  this.nodes.$sldr,
                  function() {
        ...
        _initSlides: function() {
          return (
            ...
            this.nodes.$sldr.children().css("width", this.opts.slides.width + (this.slides.widthPercentage ? "%" : "px"))
          );
        },
        _initSlidesFromAnchors: function() {
          ...
          this.nodes.$anchors.each(function(e) {
            var s = t(this),
              n = t('<div class="' + o.slide + " " + o.loading + '" />')
                .data(a.anchor, s)
        ...
        _initSlidesFromContent: function() {
          ...
          this.$node.children().each(function() {
            ...
            for (var n in t[e].media) {
              var a = null;
              if (
                (i.opts.media[n] && i.opts.media[n].filterSlides && (a = i.opts.media[n].filterSlides.call(i, s)),
                "boolean" != typeof a && (a = t[e].media[n].filterSlides.call(i, s)),
                a)
              ) {
        ...
        _loadContents: function() {
          ...
          switch (this.opts.slides.load) {
            ...
            default:
              this._loadContent(this.slides.index, this.slides.index + this.slides.visible),
                setTimeout(function() {
                  t._loadContent(t.slides.index - t.slides.visible, t.slides.index),
                    t._loadContent(t.slides.index + t.slides.visible, t.slides.index + 2 * t.slides.visible);
                }, this.conf.transitionDuration);
          }
        },
        _loadContent: function(i, s) {
          ...
          this.nodes.$slides.slice(i, s).each(function() {
            ...
            if (0 == i.children().length) {
              var s = i.data(a.anchor),
                d = s.attr("href");
              for (var l in t[e].media) {
                var p = null;
                if (
                  (n.opts.media[l] && n.opts.media[l].filterAnchors && (p = n.opts.media[l].filterAnchors.call(n, s)),
                  "boolean" != typeof p && (p = t[e].media[l].filterAnchors.call(n, s)),
                  p)
                ) {
        ...
        _complementOptions: function() {
          if (
            ("undefined" == typeof this.opts.wrapper.target && (this.opts.wrapper.target = this.$node.is("a") ? "window" : this.$node),
            "window" != this.opts.wrapper.target && "string" == typeof this.opts.wrapper.target && (this.opts.wrapper.target = t(this.opts.wrapper.target)),
            (this.opts.show = d.complBoolean(this.opts.show, "window" != this.opts.wrapper.target)),
            t.isNumeric(this.opts.slides.width))
          )
            ...
            (this.slides.widthPercentage = !0),
              (this.opts.slides.visible = d.complNumber(this.opts.slides.visible, i ? Math.floor(100 / i) : 1)),
              (this.opts.slides.width = i ? i : Math.ceil(1e4 / this.opts.slides.visible) / 100);
          }
          (this.opts.slides.slide = d.complNumber(this.opts.slides.slide, this.opts.slides.visible)),
            (this.opts.slides.offset = d.isPercentage(this.opts.slides.offset)
              ? d.getPercentage(this.opts.slides.offset)
              : d.complNumber(this.opts.slides.offset, 0));
        },
        _uniqueID: function() {
      ...
      (t.fn[e] = function(s, n, o, a) {
        l.$wndw || i(),
          (s = t.extend(!0, {}, t[e].defaults, s)),
          (s = t.extend(!0, {}, s, t[e].support.touch ? o : n)),
          (a = t.extend(!0, {}, t[e].configuration, a));
        var r = new t[e](this, s, a);
        return this.data(e, r), r.nodes.$wrpr;
      }),
      (t[e].support = { touch: "ontouchstart" in window.document || navigator.msMaxTouchPoints }),
      (t[e].defaults = {
        infinite: !1,
        effect: "slide",
      ...
      (t[e].configuration = { transitionDuration: 400 }),
      (t[e].constants = {}),
      (t[e].debug = function(t) {}),
   ...
   */ (function(t) {
    ...
    (t[a].prototype["_addon_" + r] = function() {
      ...
      p.play &&
        ...
        this.nodes.$wrpr.on(s.sliding, function(t) {
          l.autoplay();
        }),
        p.pauseOnHover &&
          this.nodes.$wrpr
            .on(s.mouseover, function(t) {
              l.autostop();
            })
      ...
      (t[a].defaults[r] = { play: !1, timeout: 4e3, pauseOnHover: !1 }),
      t[a].addons.push(r);
  })(jQuery),
  /*
   *	jQuery Touch Optimized Sliders "R"Us
   ...
   */ (function(t) {
    ...
    (t[d].prototype["_addon_" + l] = function() {
      ...
      (this.nodes.$prev = null),
        ...
        ("boolean" == typeof h || ("string" == typeof h && "inline" == h)) && (h = { prev: h, next: h }),
        "undefined" == typeof h.close && (h.close = this.vars.fixed),
        this.nodes.$slides.length < 2 && ((h.prev = !1), (h.next = !1)),
        t.each({ prev: "prev", next: "next", close: "clse" }, function(n, a) {
          h[n] &&
            ("string" == typeof h[n] && "inline" == h[n]
              ? c.vars.fixed &&
                ...
                c.nodes.$slides.on(o.loading, function(o, a) {
                  ...
                  e(c.nodes.$wrpr, r, n, 1),
                    c.opts.infinite || ((("prev" == n && t(this).is(":first-child")) || ("next" == n && t(this).is(":last-child"))) && r.addClass(s.disabled));
                })
              : ("string" == typeof h[n] && (h[n] = t(h[n])),
                (c.nodes["$" + a] = h[n] instanceof t ? h[n] : i(n, "").appendTo(c.nodes.$wrpr)),
                e(c.nodes.$wrpr, c.nodes["$" + a], n, null)));
        }),
        this.opts.infinite ||
          (this.updateButtons(),
          this.nodes.$wrpr.on(o.sliding, function(t, i, e) {
            c.updateButtons();
          }));
    }),
      (t[d].prototype.updateButtons = function() {
        this.nodes.$prev && this.nodes.$prev[(this.slides.index < 1 ? "add" : "remove") + "Class"](s.disabled),
          this.nodes.$next && this.nodes.$next[(this.slides.index >= this.slides.total - this.slides.visible ? "add" : "remove") + "Class"](s.disabled);
      }),
      (t[d].defaults[l] = { prev: !t[d].support.touch, next: !t[d].support.touch }),
      t[d].addons.push(l),
      t[d].ui.push("prev"),
      t[d].ui.push("next"),
      t[d].ui.push("close");
   ...
   */ (function(t) {
    ...
    (t[a].prototype["_addon_" + r] = function() {
      ...
      if (p.add) {
        (p.attributes = p.attributes || []),
          ...
          p.target instanceof t
            ...
            : ((this.nodes.$capt = t('<div class="' + i.caption + '" />').appendTo(this.nodes.$wrpr)),
              this.nodes.$uibg || (this.nodes.$uibg = t('<div class="' + i.uibg + '" />').prependTo(this.nodes.$wrpr)));
        ...
        this.nodes.$slides.each(function(i) {
          var s = t(this),
            n = l.vars.fixed ? s.data(e.anchor) : s.children();
          s.data(e.caption, "");
      ...
      (t[a].defaults[r] = { add: !1, target: null, attributes: ["title", "alt", "rel"] }),
      t[a].addons.push(r),
      t[a].ui.push("caption");
  })(jQuery),
  /*
        ...
        if (this.opts[r] && "slide" == this.opts.effect) {
          ...
          if (this.nodes.$slides.length > 1) {
            var p = 0,
              c = !1,
              h = !1,
              u = new Hammer(this.nodes.$wrpr[0]);
            u.on("panstart panleft panright panend swipeleft swiperight", function(t) {
              ...
              .on("panleft panright", function(t) {
                ...
                (("left" == c && l.slides.index + l.slides.visible >= l.slides.total) || ("right" == c && 0 == l.slides.index)) && (p /= 2.5),
                  l.nodes.$sldr.css("margin-left", Math.round(p));
              })
              ...
              .on("panend", function(t) {
                if (
                  ...
                  if (h) var e = l.slides.visible;
                    ...
                    var o = l.nodes.$slides.first().width(),
                      e = Math.floor((Math.abs(p) + o / 2) / o);
    ...
    (t[a].prototype["_addon_" + r] = function() {
      ...
      if (("boolean" == typeof p && p && (p = { prev: !0, next: !0, close: !0 }), t.isPlainObject(p))) {
        ...
        this.nodes.$slides.length < 2 && ((p.prev = !1), (p.next = !1)),
          t(document).on(s.keyup, function(t) {
            if (l.vars.opened) {
              var i = !1;
              switch (t.keyCode) {
                case p.prev:
      ...
      (t[a].defaults[r] = !1),
      (t[a].constants[r] = { prev: 37, next: 39, close: 27 }),
      t[a].addons.push(r);
  })(jQuery),
  /*
   *	jQuery Touch Optimized Sliders "R"Us
   ...
   */ (function(t) {
    ...
    (t[a].prototype["_addon_" + r] = function() {
      ...
      if ((this.nodes.$slides.length < 2 && (p.add = !1), p.add)) {
        if (
          ...
          p.target instanceof t
            ...
            : ((this.nodes.$pagr = t('<div class="' + i.pagination + " " + i[p.type] + '" />').appendTo(this.nodes.$wrpr)),
              this.nodes.$uibg || (this.nodes.$uibg = t('<div class="' + i.uibg + '" />').prependTo(this.nodes.$wrpr))),
        ...
        this.nodes.$slides.each(function(i) {
          ...
          this.nodes.$wrpr.on(s.sliding, function(t, i, e) {
            l.updatePagination();
          });
      }
    }),
      ...
      (t[a].defaults[r] = { add: !1, type: "bullets", target: null, anchorBuilder: null }),
      t[a].addons.push(r),
    ...
    (t[i].media[e] = {
      ...
      initAnchors: function(e, s) {
        t('<div class="' + t[i]._c("html") + '" />')
          .append(t(s))
          .appendTo(e),
          e.removeClass(t[i]._c.loading).trigger(t[i]._e.loaded);
      },
   ...
   */ (function(t) {
    function i(i) {
      ...
      var c = i.children(),
        ...
        u = c.attr("src"),
        f = h.data(s.ratio) || this.opts[d].ratio,
        g = h.data(s.maxWidth) || this.opts[d].maxWidth,
        v = h.data(s.maxHeight) || this.opts[d].maxHeight;
      i
    ...
    (t[r].media[d] = {
      ...
      initAnchors: function(e, s) {
        ...
        (s = s.split("vimeo.com/")[1].split("?")[0] + "?api=1&player_id=" + n),
          t('<iframe id="' + n + '" src="http://player.vimeo.com/video/' + s + '" frameborder="0" allowfullscreen />').appendTo(e),
          i.call(this, e);
      },
      filterSlides: function(t) {
        return t.is("iframe") && t.attr("src")
          ? t
              .attr("src")
              .toLowerCase()
              .indexOf("vimeo.com/video/") > -1
          : !1;
      },
      initSlides: function(t) {
        i.call(this, t);
      ...
      (t[r].defaults[d] = { ratio: 16 / 9, maxWidth: !1, maxHeight: !1 });
  })(jQuery),
  /*
   * jQuery Touch Optimized Sliders "R"Us
   * Youtube media
   ...
   */ (function(t) {
    function i(i) {
      ...
      var c = i.children(),
        h = i.data(t[r]._d.anchor) || t(),
        u = h.data(s.ratio) || this.opts[d].ratio,
        f = h.data(s.maxWidth) || this.opts[d].maxWidth,
        g = h.data(s.maxHeight) || this.opts[d].maxHeight;
      i
        .removeClass(e.loading)
        .trigger(n.loaded)
        .on(n.loading, function(t) {
    ...
    (t[r].media[d] = {
      ...
      initAnchors: function(e, s) {
        ...
        (s = s.split("?v=")[1].split("&")[0]),
          this.opts[d].imageLink
            ? ((s = "http://img.youtube.com/vi/" + s + "/0.jpg"),
              t('<a href="' + n + '" class="' + t[r]._c("play") + '" target="_blank" />').appendTo(e),
              t('<img border="0" />')
                ...
                .appendTo(e)
                .attr("src", s))
            : (t('<iframe src="http://www.youtube.com/embed/' + s + '?enablejsapi=1" frameborder="0" allowfullscreen />').appendTo(e), i.call(this, e));
      },
      filterSlides: function(t) {
        return t.is("iframe") && t.attr("src")
          ? t
      ...
      (t[r].defaults.media[d] = {}),
      (t[r].defaults[d] = { ratio: 16 / 9, maxWidth: !1, maxHeight: !1, imageLink: t[r].support.touch });
  })(jQuery);
